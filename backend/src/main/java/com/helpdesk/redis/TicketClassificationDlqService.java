...
@Service
public class TicketClassificationDlqService {

    private final RedisTemplate<String, String> redisTemplate;

    public TicketClassificationDlqService(
    ...
    public int reprocessForOrganization(UUID organizationId) {
        ...
        for (MapRecord<String, Object, Object> message : messages) {
            ...
            retryValues.put("ticketId", String.valueOf(values.get("ticketId")));
            retryValues.put("organizationId", String.valueOf(values.get("organizationId")));
            retryValues.put("subject", String.valueOf(values.get("subject")));
            retryValues.put("priority", String.valueOf(values.get("priority")));
